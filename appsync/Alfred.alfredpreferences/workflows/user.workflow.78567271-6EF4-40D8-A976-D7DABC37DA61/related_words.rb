...
RELATED_WORDS = {
  ...
  'stuck_out_tongue_closed_eyes' => ['face', 'prank'],
  ...
  'heavy_exclamation_mark' => ['surprise'],
  ...
  'oncoming_police_car' => ['vehicle', 'law', 'enforcement'],
  ...
  'aquarius' => ['sign', 'purple-square'],
  'aries' => ['sign', 'purple-square'],
  ...
  'pisces' => ['purple-square', 'sign'],
  'taurus' => ['purple-square', 'sign'],
  ...
  'police_car' => ['vehicle', 'cars', 'transportation', 'law', 'enforcement'],
  ...
  'doughnut' => ['food', 'desert', 'snack', 'sweet'],
  'beers' => ['relax', 'beverage', 'drink', 'drunk', 'party', 'pub'],
  ...
  'chocolate_bar' => ['food', 'snack', 'desert'],
  'gb' => ['nation', 'flag', 'britsh', 'UK'],
  ...
  'non-potable_water' => [],
  'clock530' => ['time', 'clock'],
  'hammer' => ['tools', 'verdict', 'judge', 'done', 'law', 'ruling'],
  ...
  'christmas_tree' => ['festival', 'vacation', 'december', 'xmas']
}
